...
export const GENRES = [
  'Drama', 'Comedy', 'Romance', 'Thriller', 'Sci-Fi', 'Fantasy', 'Horror', 'Mystery', 'Action', 'Documentary', 'Slice of Life', 'Animation',
]

export const BOOK_GENRES = [
  'Fiction', 'Non-fiction', 'Self-help', 'Fantasy', 'Mystery', 'Romance', 'Poetry', 'Biography', 'Philosophy', 'Sci-Fi',
]

export const REFINEMENTS = [
  { id: 'different', label: 'Something different' },
  { id: 'less_emotional', label: 'Less emotional' },
  { id: 'more_comforting', label: 'More comforting' },
  { id: 'more_exciting', label: 'More exciting' },
]
